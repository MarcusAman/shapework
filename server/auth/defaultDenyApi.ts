...
export const PUBLIC_API_ROUTES: PublicApiRoute[] = [
  ...
  { method: 'POST', path: '/api/retell/nest-ops/voice-grounding' },
  { method: 'POST', path: '/api/nora/voice-grounding' },
  { method: 'POST', path: '/api/voice-agent/telephony/inbound-lookup' },
  { method: 'POST', path: '/api/voice-agent/telephony/verify-name' },
  { method: 'POST', path: '/api/voice-agent/telephony/office-supplies/request' },
  { method: 'POST', path: '/api/twilio/voice' },
  { method: 'GET', path: '/api/twilio/voice' },
  { method: 'POST', path: '/api/twilio/voice/inbound' },
  { method: 'GET', path: '/api/twilio/voice/inbound' },
  { method: 'POST', path: '/api/telephony/inbound-voice' },
  { method: 'GET', path: '/api/telephony/inbound-voice' },
  { method: 'POST', path: '/api/twilio/sms' },
  { method: 'POST', path: '/api/twilio/mms' },
  { method: 'POST', path: '/api/telephony/inbound-mms' },
  { method: 'POST', path: '/api/mms/inbound' },
