...
export const INITIAL_NEST_SOPS: Record<string, SopDocument> = {
  ...
  'sop_marketing_intake_003': {
    ...
    orderedSteps: [
      ...
      { id: 'st_3', stepNumber: 3, action: 'Submit promotional assets to listing agent for 1-click review and approval.', role: 'Listing Agent', primaryRole: 'Listing Agent', secondaryRole: 'Marketing Lead', durationPolicy: { preset: '30m', customMinutes: 30, rawDisplay: '30 mins' }, affirmationCheck: 'Promotional collateral reviewed and approved by listing agent.', systemUsed: 'Approval Center' },
