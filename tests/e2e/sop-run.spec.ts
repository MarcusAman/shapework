...
test('SOP Runs Flow - Complete, Block, and URL Evidence Verification', async ({ page }) => {
  ...
  // Assert uploader is labelled unavailable and URL entry works
  await expect(page.locator('text=Local file upload is not configured for this workspace').first()).toBeVisible();
});
